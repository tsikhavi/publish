...
const Search = () => {
  ...
  return (
    <div className="h-13 flex-shrink-2 relative mx-32 flex w-40 flex-1 ">
      ...
      <input
        ...
        id="Search"
        placeholder="Поиск"
        className="placeholder:font-regular w-full rounded-full border-none bg-[#343434]/90 py-2.5 pe-10 pr-2 text-white
         shadow-sm placeholder:text-xs placeholder:text-white focus:ring-2 focus:ring-inset focus:ring-[#64D28B] sm:text-sm"
        value={searchTerm}
        onChange={handleSearch}
      />

      <span className="absolute inset-y-0 end-0 mx-0 my-2 grid place-content-center rounded-3xl bg-[#64D28B] px-5 py-2">
